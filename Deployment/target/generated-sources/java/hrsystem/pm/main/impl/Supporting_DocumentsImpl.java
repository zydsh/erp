...
public class Supporting_DocumentsImpl extends ModelInstance<Supporting_Documents,Pm> implements Supporting_Documents {
    ...
    private Supporting_DocumentsImpl( Pm context ) {
        ...
        m_State = "";
        m_Notes = "";
        R3_Milestone_inst = MilestoneImpl.EMPTY_MILESTONE;
    }
    ...
    // selections
    private Milestone R3_Milestone_inst;
    @Override
    public void setR3_Milestone( Milestone inst ) {
        R3_Milestone_inst = inst;
    }
    @Override
    public Milestone R3_Milestone() throws XtumlException {
        return R3_Milestone_inst;
    }
