...
public class ProjectImpl extends ModelInstance<Project,Pm> implements Project {
    ...
    public static Project create( Pm context, UniqueId instanceId, String m_Name ) throws XtumlException {
        Project newProject = new ProjectImpl( context, instanceId, m_Name );
        if ( context.addInstance( newProject ) ) {
            return newProject;
        }
        else throw new InstancePopulationException( "Instance already exists within this population." );
