...
public class Supporting_DocumentsSetImpl extends InstanceSet<Supporting_DocumentsSet,Supporting_Documents> implements Supporting_DocumentsSet {
    ...
    // selections
    @Override
    public MilestoneSet R3_Milestone() throws XtumlException {
        MilestoneSet milestoneset = new MilestoneSetImpl();
        for ( Supporting_Documents supporting_documents : this ) milestoneset.add( supporting_documents.R3_Milestone() );
        return milestoneset;
    }
