    ...
    public void deliver( IMessage message ) throws XtumlException {
        ...
        switch ( message.getId() ) {
            ...
            case IData.SIGNAL_NO_SENDEMPLOYEE:
                SendEmployee(IntegerUtil.deserialize(message.get(0)), IntegerUtil.deserialize(message.get(1)), StringUtil.deserialize(message.get(2)), StringUtil.deserialize(message.get(3)), StringUtil.deserialize(message.get(4)), StringUtil.deserialize(message.get(5)), StringUtil.deserialize(message.get(6)), IntegerUtil.deserialize(message.get(7)), StringUtil.deserialize(message.get(8)), StringUtil.deserialize(message.get(9)), IntegerUtil.deserialize(message.get(10)), IntegerUtil.deserialize(message.get(11)), IntegerUtil.deserialize(message.get(12)));
                break;
        default:
