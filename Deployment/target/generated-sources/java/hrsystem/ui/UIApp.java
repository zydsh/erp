...
public class UIApp extends Port<UI> implements IData {
    ...
    public void SendEmployee( final int p_EmployeeID,  final int p_NationalID,  final String p_FirstName,  final String p_MiddleName,  final String p_LastName,  final String p_Email,  final int p_OfficePhone,  final int p_DateOfBirth,  final String p_Degree,  final String p_Gender,  final int p_StartDate,  final int p_LeaveBalance,  final int p_SickLeaveBalance ) throws XtumlException {
        context().SendEmployee( p_EmployeeID, p_NationalID, p_FirstName, p_MiddleName, p_LastName, p_Email, p_OfficePhone, p_DateOfBirth, p_Degree, p_Gender, p_StartDate, p_LeaveBalance, p_SickLeaveBalance );
    }
    ...
    public void deliver( IMessage message ) throws XtumlException {
        ...
        switch ( message.getId() ) {
            ...
            case IData.SIGNAL_NO_SENDEMPLOYEE:
                SendEmployee(IntegerUtil.deserialize(message.get(0)), IntegerUtil.deserialize(message.get(1)), StringUtil.deserialize(message.get(2)), StringUtil.deserialize(message.get(3)), StringUtil.deserialize(message.get(4)), StringUtil.deserialize(message.get(5)), IntegerUtil.deserialize(message.get(6)), IntegerUtil.deserialize(message.get(7)), StringUtil.deserialize(message.get(8)), StringUtil.deserialize(message.get(9)), IntegerUtil.deserialize(message.get(10)), IntegerUtil.deserialize(message.get(11)), IntegerUtil.deserialize(message.get(12)));
                break;
