...
public class Fm extends Component<Fm> {

    private Map<String, Class<?>> classDirectory;

    public Fm(IApplication app, IRunContext runContext, int populationId) {
    ...
    private FmFin FmFin;
    public FmFin Fin() {
        if ( null == FmFin ) FmFin = new FmFin( this, null );
        return FmFin;
    }
    ...
    public String getVersion() {
        ...
        try {
            prop.load(getClass().getResourceAsStream("FmProperties.properties"));
