...
public interface IPmCRUD {
    ...
    public static class Initiative extends Message {
        public Initiative( final String p_Name,  final String p_Short_Number,  final String p_Long_Number,  final String p_Description,  final int p_Start_Date,  final int p_Actual_Start_Date,  final int p_End_Date,  final int p_Actual_End_Date,  final double p_Budget,  final String p_Str_Name,  final String p_Action ) {
            super(new Object[]{p_Name,  p_Short_Number,  p_Long_Number,  p_Description,  p_Start_Date,  p_Actual_Start_Date,  p_End_Date,  p_Actual_End_Date,  p_Budget,  p_Str_Name,  p_Action});
        }
        @Override
        public int getId() {
    ...
    public static class Milestone extends Message {
        public Milestone( final String p_Name,  final String p_Full_Code,  final String p_Code,  final String p_Type,  final String p_Success_Criteria,  final int p_Complete_Planned,  final int p_Complete_Actual,  final int p_Complete,  final int p_Weight,  final int p_Percentage,  final String p_sd_State,  final String p_sd_Description,  final String p_Notes,  final String p_Incomplete_Reasons,  final String p_Initiative_Number,  final String p_Action ) {
            super(new Object[]{p_Name,  p_Full_Code,  p_Code,  p_Type,  p_Success_Criteria,  p_Complete_Planned,  p_Complete_Actual,  p_Complete,  p_Weight,  p_Percentage,  p_sd_State,  p_sd_Description,  p_Notes,  p_Incomplete_Reasons,  p_Initiative_Number,  p_Action});
        }
        @Override
        public int getId() {
    ...
    public static class Supporting_Documents extends Message {
        public Supporting_Documents( final String p_Name,  final String p_Document,  final String p_State,  final String p_Notes,  final String p_Full_Code,  final String p_Action ) {
            super(new Object[]{p_Name,  p_Document,  p_State,  p_Notes,  p_Full_Code,  p_Action});
        }
        @Override
        public int getId() {
