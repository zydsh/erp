...
public class MilestoneSetImpl extends InstanceSet<MilestoneSet,Milestone> implements MilestoneSet {
    ...
    // selections
    @Override
    public InitiativeSet R2_achieved_by_Initiative() throws XtumlException {
        InitiativeSet initiativeset = new InitiativeSetImpl();
        for ( Milestone milestone : this ) initiativeset.add( milestone.R2_achieved_by_Initiative() );
