...
public class EmployeeSetImpl extends InstanceSet<EmployeeSet,Employee> implements EmployeeSet {
    ...
    public void setOfficePhone( String m_OfficePhone ) throws XtumlException {
        for ( Employee employee : this ) employee.setOfficePhone( m_OfficePhone );
    }
    @Override
    ...
    public void setEmail( String m_Email ) throws XtumlException {
        for ( Employee employee : this ) employee.setEmail( m_Email );
    }
    @Override
    ...
    public BonusSet R19_was_given_Bonus() throws XtumlException {
        ...
        for ( Employee employee : this ) bonusset.addAll( employee.R19_was_given_Bonus() );
        return bonusset;
    }
    @Override
