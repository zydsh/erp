...
import erp.hr.HrAuthenticate;
import erp.hr.HrUI;
import erp.hr.HrUI_Ops;
import erp.hr.main.Bonus;
import erp.hr.main.BonusSet;
import erp.hr.main.BonusSpecification;
import erp.hr.main.BonusSpecificationSet;
...
import erp.hr.main.impl.BonusImpl;
import erp.hr.main.impl.BonusSetImpl;
import erp.hr.main.impl.BonusSpecificationImpl;
import erp.hr.main.impl.BonusSpecificationSetImpl;
import erp.hr.main.impl.DepartmentImpl;
import erp.hr.main.impl.DepartmentSetImpl;
import erp.hr.main.impl.EmployeeImpl;
import erp.hr.main.impl.EmployeeSetImpl;
import erp.hr.main.impl.GradeImpl;
import erp.hr.main.impl.GradeSetImpl;
import erp.hr.main.impl.JobImpl;
import erp.hr.main.impl.JobRecordImpl;
import erp.hr.main.impl.JobRecordSetImpl;
import erp.hr.main.impl.JobSetImpl;
import erp.hr.main.impl.LeaveImpl;
import erp.hr.main.impl.LeaveSetImpl;
import erp.hr.main.impl.LeaveSpecificationImpl;
import erp.hr.main.impl.LeaveSpecificationSetImpl;
import erp.hr.main.impl.PayslipItemImpl;
import erp.hr.main.impl.PayslipItemSetImpl;
import erp.hr.main.impl.ScaleImpl;
import erp.hr.main.impl.ScaleSetImpl;
import erp.hr.messagecenter.ApproveLeave;
import erp.hr.messagecenter.ApproveLeaveSet;
import erp.hr.messagecenter.impl.ApproveLeaveImpl;
import erp.hr.messagecenter.impl.ApproveLeaveSetImpl;
...
public class Hr extends Component<Hr> {
    ...
    public Hr(IApplication app, IRunContext runContext, int populationId) {
        ...
        R14_Grade_bellow_Grade_extent = new RelationshipSet();
    ...
    public void CreatePEI_Departments() throws XtumlException {
        ...
        context().relate_R21_Employee_working_within_Department( emp, vpServices );
        context().relate_R22_Department_is_part_of_Department( departmentHR, vpServices );
        context().LOG().LogInfo( ( ( "Departments: related: " + vpServices.getName() ) + " to " ) + departmentHR.getName() );
        context().relate_R22_Department_is_part_of_Department( departmentFin, vpServices );
        context().LOG().LogInfo( ( ( "Departments: related: " + vpServices.getName() ) + " to " ) + departmentFin.getName() );
        ...
        context().relate_R21_Employee_working_within_Department( emp, vpServices );
        context().relate_R22_Department_is_part_of_Department( vpServices, President );
    ...
    public void CreatePEI_Employees() throws XtumlException {
        ...
        emp.setEmail("S.Alotaibi@kacst.edu.sa");
        ...
        emp.setEmail("R.Almutairi@kacst.edu.sa");
        ...
        emp.setEmail("R.Alshareef@kacst.edu.sa");
    ...
    public void CreatePEI_Scale() throws XtumlException {
        ...
        context().relate_R14_Grade_bellow_Grade( grade2, grade );
        ...
        context().relate_R14_Grade_bellow_Grade( grade3, grade2 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade4, grade3 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade5, grade4 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade6, grade5 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade7, grade6 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade8, grade7 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade9, grade8 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade10, grade9 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade11, grade10 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade12, grade11 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade13, grade12 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade14, grade13 );
        ...
        context().relate_R14_Grade_bellow_Grade( grade15, grade14 );
    ...
    public void relate_R14_Grade_bellow_Grade( Grade form, Grade part ) throws XtumlException {
        if ( null == form || null == part ) throw new BadArgumentException( "Null instances passed." );
        if ( form.isEmpty() || part.isEmpty() ) throw new EmptyInstanceException( "Cannot relate empty instances." );
        // TODO cardinality check
        if ( R14_Grade_bellow_Grade_extent.add( new Relationship( form.getInstanceId(), part.getInstanceId() ) ) ) {
            part.setR14_above_Grade(form);
            form.setR14_bellow_Grade(part);
        }
        else throw new ModelIntegrityException( "Instances could not be related." );
    }

    public void unrelate_R14_Grade_bellow_Grade( Grade form, Grade part ) throws XtumlException {
        if ( null == form || null == part ) throw new BadArgumentException( "Null instances passed." );
        if ( form.isEmpty() || part.isEmpty() ) throw new EmptyInstanceException( "Cannot unrelate empty instances." );
        if ( R14_Grade_bellow_Grade_extent.remove( R14_Grade_bellow_Grade_extent.get( form.getInstanceId(), part.getInstanceId() ) ) ) {
            part.setR14_above_Grade(GradeImpl.EMPTY_GRADE);
            form.setR14_bellow_Grade(GradeImpl.EMPTY_GRADE);
        }
        else throw new ModelIntegrityException( "Instances could not be unrelated." );
    }
    ...
    private IRelationshipSet R14_Grade_bellow_Grade_extent;
    public IRelationshipSet R14_Grade_bellow_Grades() throws XtumlException {
        return R14_Grade_bellow_Grade_extent;
    }
